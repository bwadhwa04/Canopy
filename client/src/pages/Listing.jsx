...
//             ))}
//           </Swiper>
//           <div className="p-3 md:mx-52 flex flex-col gap-4 my-6">
...
//               {listing.type === "rent" && " / month"}
//             </p>
//             <p className="flex  items-center my-2 gap-2 text-slate-600 text-md">
//               <FaMapMarkerAlt className="text-green-700" />
//               {listing.address}
//             </p>
//             <div className="flex gap-4">
...
// //   return (
// //     <main>
// //       {loading && <p className="text-center my-14 text-2xl">Loading...</p>}
// //       {error && (
// //         <p className="text-center my-7 text-2xl">Something went wrong!</p>
// //       )}
// //       {listing && !loading && !error && (
